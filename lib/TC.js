	...
	TC = {
		...
		load_script: function (url, callback) {
			if (loaded_urls[url] === undefined) {
				$.getScript(this.LIB_PATH + url, function () {
		...
		initialize: function (path, callback) {
			...
			TC.load_script("Component.js", check_done);
			TC.load_script("Controller.js", check_done);
			TC.load_script("Compiler.js", check_done);
		},
